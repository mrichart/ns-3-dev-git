...
int main (int argc, char *argv[])
{
  ...
  cmd.AddValue ("STA2_x", "Position of STA1 in x coordinate", sta2_x);
  cmd.AddValue ("STA2_y", "Position of STA1 in y coordinate", sta2_y);
  cmd.Parse (argc, argv);
  ...
  onoff2.SetConstantRate (DataRate ("100Mb/s"), 1420);
