...
int main (int argc, char *argv[])
{
  ...
  if (standard == "802.11a" || standard == "802.11b" || standard == "802.11g")
  ...
  else if (standard == "802.11n-2.4GHz" || standard == "802.11n-5GHz")
    {
      ...
      //Configure the AP node
      wifi.SetRemoteStationManager (apManager, "RtsCtsThreshold", UintegerValue (rtsThreshold), "PrintStats", BooleanValue(true));
  ...
  mobility.SetPositionAllocator ("ns3::RandomDiscPositionAllocator",
                                 "X", StringValue ("0.0"),
                                 "Y", StringValue ("0.0"),
                                 "Rho", StringValue ("ns3::UniformRandomVariable[Min=0|Max=3]"));
  ...
  onoff0.SetAttribute ("StopTime", TimeValue (Seconds (30)));
  ApplicationContainer apps_source = onoff0.Install (wifiApNodes.Get (0));

  OnOffHelper onoff0_2 ("ns3::UdpSocketFactory", remote0_1);
  onoff0_2.SetConstantRate (DataRate ("5Mb/s"), 1420);
  onoff0_2.SetAttribute ("StartTime", TimeValue (Seconds (30)));
  onoff0_2.SetAttribute ("StopTime", TimeValue (Seconds (90)));
  apps_source = onoff0_2.Install (wifiApNodes.Get (0));

  OnOffHelper onoff0_3 ("ns3::UdpSocketFactory", remote0_1);
  onoff0_3.SetConstantRate (DataRate ("10Mb/s"), 1420);
  onoff0_3.SetAttribute ("StartTime", TimeValue (Seconds (90)));
  onoff0_3.SetAttribute ("StopTime", TimeValue (Seconds (simuTime)));
  apps_source = onoff0_3.Install (wifiApNodes.Get (0));
  ...
  onoff1.SetAttribute ("StopTime", TimeValue (Seconds (30)));
  apps_source.Add(onoff1.Install (wifiApNodes.Get (0)));

  OnOffHelper onoff1_2 ("ns3::UdpSocketFactory", remote1_1);
  onoff1_2.SetConstantRate (DataRate ("5Mb/s"), 1420);
  onoff1_2.SetAttribute ("StartTime", TimeValue (Seconds (30)));
  onoff1_2.SetAttribute ("StopTime", TimeValue (Seconds (90)));
  apps_source = onoff1_2.Install (wifiApNodes.Get (0));

  OnOffHelper onoff1_3 ("ns3::UdpSocketFactory", remote1_1);
  onoff1_3.SetConstantRate (DataRate ("10Mb/s"), 1420);
  onoff1_3.SetAttribute ("StartTime", TimeValue (Seconds (90)));
  onoff1_3.SetAttribute ("StopTime", TimeValue (Seconds (simuTime)));
  apps_source = onoff1_3.Install (wifiApNodes.Get (0));
  ...
  onoff2.SetAttribute ("StopTime", TimeValue (Seconds (30)));
  apps_source.Add(onoff2.Install (wifiApNodes.Get (0)));

  OnOffHelper onoff2_2 ("ns3::UdpSocketFactory", remote2_1);
  onoff2_2.SetConstantRate (DataRate ("5Mb/s"), 1420);
  onoff2_2.SetAttribute ("StartTime", TimeValue (Seconds (30)));
  onoff2_2.SetAttribute ("StopTime", TimeValue (Seconds (90)));
  apps_source = onoff2_2.Install (wifiApNodes.Get (0));

  OnOffHelper onoff2_3 ("ns3::UdpSocketFactory", remote2_1);
  onoff2_3.SetConstantRate (DataRate ("10Mb/s"), 1420);
  onoff2_3.SetAttribute ("StartTime", TimeValue (Seconds (90)));
  onoff2_3.SetAttribute ("StopTime", TimeValue (Seconds (simuTime)));
  apps_source = onoff2_3.Install (wifiApNodes.Get (0));
  ...
  onoff3.SetAttribute ("StopTime", TimeValue (Seconds (30)));
  apps_source.Add(onoff3.Install (wifiApNodes.Get (0)));

  OnOffHelper onoff3_2 ("ns3::UdpSocketFactory", remote3_1);
  onoff3_2.SetConstantRate (DataRate ("5Mb/s"), 1420);
  onoff3_2.SetAttribute ("StartTime", TimeValue (Seconds (30)));
  onoff3_2.SetAttribute ("StopTime", TimeValue (Seconds (90)));
  apps_source = onoff3_2.Install (wifiApNodes.Get (0));

  OnOffHelper onoff3_3 ("ns3::UdpSocketFactory", remote3_1);
  onoff3_3.SetConstantRate (DataRate ("10Mb/s"), 1420);
  onoff3_3.SetAttribute ("StartTime", TimeValue (Seconds (90)));
  onoff3_3.SetAttribute ("StopTime", TimeValue (Seconds (simuTime)));
  apps_source = onoff3_3.Install (wifiApNodes.Get (0));

  //-------------- User 4 - Slice 1 -----------------------
  InetSocketAddress remote3_2 = InetSocketAddress (i.GetAddress (3), port2);
  remote3_2.SetTos(32);
  OnOffHelper onoff3S1 ("ns3::UdpSocketFactory",  remote3_2);
  onoff3S1.SetConstantRate (DataRate ("15Mb/s"), 1420);
  onoff3S1.SetAttribute ("StartTime", TimeValue (Seconds (0.5)));
  onoff3S1.SetAttribute ("StopTime", TimeValue (Seconds (60)));
  apps_source.Add(onoff3S1.Install (wifiApNodes.Get (0)));

  OnOffHelper onoff3S1_2 ("ns3::UdpSocketFactory",  remote3_2);
  onoff3S1_2.SetConstantRate (DataRate ("15Mb/s"), 1420);
  onoff3S1_2.SetAttribute ("StartTime", TimeValue (Seconds (90)));
  onoff3S1_2.SetAttribute ("StopTime", TimeValue (Seconds (simuTime)));
  apps_source.Add(onoff3S1_2.Install (wifiApNodes.Get (0)));

  //-------------- User 5 - Slice 1 -----------------------
  InetSocketAddress remote4_2 = InetSocketAddress (i.GetAddress (4), port2);
  remote4_2.SetTos(32);
  OnOffHelper onoff4 ("ns3::UdpSocketFactory",  remote4_2);
  onoff4.SetConstantRate (DataRate ("15Mb/s"), 1420);
  onoff4.SetAttribute ("StartTime", TimeValue (Seconds (0.5)));
  onoff4.SetAttribute ("StopTime", TimeValue (Seconds (60)));
  apps_source.Add(onoff4.Install (wifiApNodes.Get (0)));

  OnOffHelper onoff4_2 ("ns3::UdpSocketFactory",  remote4_2);
  onoff4_2.SetConstantRate (DataRate ("15Mb/s"), 1420);
  onoff4_2.SetAttribute ("StartTime", TimeValue (Seconds (90)));
  ...
  onoff5.SetConstantRate (DataRate ("15Mb/s"), 1420);
  onoff5.SetAttribute ("StartTime", TimeValue (Seconds (0.5)));
  onoff5.SetAttribute ("StopTime", TimeValue (Seconds (60)));
  apps_source.Add(onoff5.Install (wifiApNodes.Get (0)));

  OnOffHelper onoff5_2 ("ns3::UdpSocketFactory",  remote5_2);
  onoff5_2.SetConstantRate (DataRate ("15Mb/s"), 1420);
  onoff5_2.SetAttribute ("StartTime", TimeValue (Seconds (90)));
  ...
  onoff6.SetConstantRate (DataRate ("15Mb/s"), 1420);
  onoff6.SetAttribute ("StartTime", TimeValue (Seconds (0.5)));
  onoff6.SetAttribute ("StopTime", TimeValue (Seconds (60)));
  apps_source.Add(onoff6.Install (wifiApNodes.Get (0)));

  OnOffHelper onoff6_2 ("ns3::UdpSocketFactory",  remote6_2);
  onoff6_2.SetConstantRate (DataRate ("15Mb/s"), 1420);
  onoff6_2.SetAttribute ("StartTime", TimeValue (Seconds (90)));
  ...
  remote1_3.SetTos(64);
  OnOffHelper onoff1S2 ("ns3::UdpSocketFactory",  remote1_3);
  onoff1S2.SetConstantRate (DataRate ("15Mb/s"), 1420);
  onoff1S2.SetAttribute ("StartTime", TimeValue (Seconds (0.5)));
  onoff1S2.SetAttribute ("StopTime", TimeValue (Seconds (simuTime)));
  apps_source.Add(onoff1S2.Install (wifiApNodes.Get (0)));

  //-------------- User 7 - Slice 2 -----------------------
  InetSocketAddress remote6_3 = InetSocketAddress (i.GetAddress (6), port3);
  remote6_3.SetTos(64);
  OnOffHelper onoff6S2 ("ns3::UdpSocketFactory",  remote6_3);
  onoff6S2.SetConstantRate (DataRate ("15Mb/s"), 1420);
  onoff6S2.SetAttribute ("StartTime", TimeValue (Seconds (0.5)));
  onoff6S2.SetAttribute ("StopTime", TimeValue (Seconds (simuTime)));
  apps_source.Add(onoff6S2.Install (wifiApNodes.Get (0)));

  //-------------- User 8 - Slice 2 -----------------------
  InetSocketAddress remote7_3 = InetSocketAddress (i.GetAddress (7), port3);
  remote7_3.SetTos(64);
  OnOffHelper onoff7 ("ns3::UdpSocketFactory",  remote7_3);
  onoff7.SetConstantRate (DataRate ("15Mb/s"), 1420);
  ...
  onoff8.SetConstantRate (DataRate ("15Mb/s"), 1420);
  ...
  onoff9.SetConstantRate (DataRate ("15Mb/s"), 1420);
