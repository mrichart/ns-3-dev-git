...
NS_LOG_COMPONENT_DEFINE ("PowerAdaptationInterferenceDistance");
...
int main (int argc, char *argv[])
{
  ...
  wifiChannel.AddPropagationLoss ("ns3::ThreeLogDistancePropagationLossModel", "Distance1", DoubleValue(50));
...
*/
  ...
  Simulator::Schedule (Seconds (20), &NodeStatistics::AdvancePosition, &statisticsAp1, wifiApNodes.Get (1), 1, 1);
