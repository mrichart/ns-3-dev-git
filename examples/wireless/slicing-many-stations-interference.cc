...
int main (int argc, char *argv[])
{
  ...
  onoff.SetConstantRate (DataRate ("50Mb/s"), 1420);
  onoff.SetAttribute ("StartTime", TimeValue (Seconds (20)));
  onoff.SetAttribute ("StopTime", TimeValue (Seconds (50)));
  onoff.Install (wifiInterfererAp.Get (0));
