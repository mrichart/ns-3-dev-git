...
/** 
   ...
   */
  static uint32_t GetPlcpHtTrainingSymboldDurationMicroSeconds (WifiMode payloadMode, WifiPreamble preamble, WifiTxVector txvector);
/** 
   * \param payloadMode the WifiMode use for the transmission of the payload
   * \param preamble the type of preamble
   * 
...
/** 
   ...
   */
  static uint32_t GetPayloadDurationMicroSeconds (uint32_t size, WifiTxVector txvector);
  ...
  */
   ...
   */
  virtual void SetNumberOfTx (uint32_t tx)=0;
   /**
   * \param the number of recievers on this node.
   */
  virtual void SetNumberOfRx (uint32_t rx)=0 ;
  /**
 ...
 /**
  ...
  virtual uint32_t GetFreq (void) const=0;

  virtual uint32_t GetNumberOfTx (void) const=0;
   /**
   * \returns the number of recievers on this node.
   */
  virtual uint32_t GetNumberOfRx (void) const=0;
  /**
