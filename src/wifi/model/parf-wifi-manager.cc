  ...
  if (!station->m_initialized)
    {
      ...
      m_powerChange (station->m_prevRateIndex, station->m_powerLevel, station->m_state->m_address);
      m_rateChange (station->m_prevPowerLevel, station->m_rateIndex, station->m_state->m_address);
