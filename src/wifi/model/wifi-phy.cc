...
uint32_t
WifiPhy::GetPlcpHtTrainingSymboldDurationMicroSeconds (WifiMode payloadMode, WifiPreamble preamble, WifiTxVector txvector)
{
   switch (preamble)
     {
...
WifiPhy::CalculateTxDuration (uint32_t size, WifiTxVector txvector, WifiPreamble preamble)
{
  ...
  uint32_t duration = GetPlcpPreambleDurationMicroSeconds (payloadMode, preamble)
    ...
    + GetPlcpHtTrainingSymboldDurationMicroSeconds (payloadMode, preamble,txvector)
